...
const Toast: React.FC<ToastProps> = ({
  ...
  const typeClasses = {
    ...
    warning:
      "bg-warning-50 border-warning-200 text-warning-800 dark:bg-warning-900/20 dark:border-warning-800 dark:text-warning-400",
  ...
  return (
    <div
      className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg border shadow-lg ${typeClasses[type]} animate-in slide-in-from-top-5 fade-in duration-300`}
    >
      <div className="p-4">
