...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Cyber Sentinel - Security Dashboard Platform"
        description="This is React.js Avatars Dashboard page for Cyber Sentinel - Tailwind CSS Admin Dashboard Template"
      />
