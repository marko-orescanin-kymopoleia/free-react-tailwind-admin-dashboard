...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Cyber Sentinel - Security Dashboard Platform"
        description="This is React.js Badges Dashboard page for Cyber Sentinel - Tailwind CSS Admin Dashboard Template"
      />
