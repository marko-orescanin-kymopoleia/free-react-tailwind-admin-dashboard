...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Cyber Sentinel - Security Dashboard Platform"
        description="This is React.js Videos page for Cyber Sentinel - Tailwind CSS Admin Dashboard Template"
      />
